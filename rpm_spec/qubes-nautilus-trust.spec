...
Name:           qubes-nautilus-trust
Version:        3.22.3
Release:        1%{?dist}
Summary:	Patched version of Nautilus that supports file-open events
...
%changelog
* Mon Aug 28 2017 Andrew Morgan <andrew@amorgan.xyz> - 3.22.3-1
- Added ability for extensions to know when files are opened
